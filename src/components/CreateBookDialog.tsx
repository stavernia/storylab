...
export function CreateBookDialog({ isOpen, onClose, onCreateBook }: CreateBookDialogProps) {
      ...
      <div className="relative bg-white rounded-lg shadow-2xl w-full max-w-md">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <div>
            ...
            <p className="text-xs text-gray-600 mt-0.5">Add a new book to your library</p>
          </div>
          <button
            onClick={handleClose}
            disabled={isCreating}
        ...
        <form onSubmit={handleSubmit}>
          <div className="px-6 py-5 space-y-4">
            {/* Title Field */}
            <div>
              <label htmlFor="book-title" className="block text-sm font-medium text-gray-700 mb-1.5">
            ...
            {/* Description Field */}
            <div>
              <label htmlFor="book-description" className="block text-sm font-medium text-gray-700 mb-1.5">
